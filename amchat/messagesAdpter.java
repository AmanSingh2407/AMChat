...
public class messagesAdpter extends  RecyclerView.Adapter {
    ...
    public messagesAdpter(Context context, ArrayList<msgModelclass> messagessArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == senderViewHolder.class){
            ...
            Picasso.get().load(chatWin.senderImg).into(viewHolder.circleImageView);

        }
        else {
            reciverViewHolder viewHolder = (reciverViewHolder) holder;
            viewHolder.msgtxt.setText(message.getMessage());
            Picasso.get().load(chatWin.reciverIImg).into(viewHolder.circleImageView);
        }
